    ...
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className={`
          ...
          ${isExpanded
            ? 'rounded-[14px] pl-3 pr-4 py-2.5 max-w-[220px]'
          ...
          >
            ...
            >
              <path
                ...
                strokeLinejoin="round"
              />
              <polyline points="16 6 12 2 8 6" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
              <line x1="12" y1="2" x2="12" y2="15" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
        </PopoverTrigger>
